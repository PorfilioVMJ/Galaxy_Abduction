...
import galaxyblast.gui.menus.DebugMenu;
import galaxyblast.gui.menus.LoginMenu;
import galaxyblast.gui.menus.Menu;
...
public class GalaxyAbduction extends Canvas implements Runnable{
	...
	private Menu menu;
	//TODO: LOGINMENU Find better access
	...
	private boolean isInDebugMenu = false;
	...
	public static StringBuilder userBuild = new StringBuilder();
	...
	public void render(){
		...
		if(State == STATE.GAME){
			...
			g.drawString("FPS: " + debug_fps, 150, 455);
		...
		if(State == STATE.OPTIONS){
			...
			g.setColor(Color.BLUE);
			g.setFont(font4);
			g.drawString("Username: " + userBuild.toString(), 25, 220);
		...
		if(State == STATE.DEBUG){
			...
			g.setColor(Color.CYAN);
			g.setFont(font3);
			g.drawString("FPS: " + debug_fps, XSize-60, 15);
		}
	...
	public void keyPressed(KeyEvent e){
		...
		if(State == STATE.GAME){
			...
			loginMenu.setText(userBuild.toString());
		}
	}
	...
	public static void main(String[] args){
		...
		//data.writeDataFile("assets/data.vmj", "test");
		//data.loadFile("assets/data.vmj");
	}
	
	public boolean isInDebugMenu() {
		return isInDebugMenu;
	}

	public void setInDebugMenu(boolean isInDebugMenu) {
		this.isInDebugMenu = isInDebugMenu;
	}
